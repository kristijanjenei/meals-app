...
const DUMMY_MEALS = const [
  ...
  Meal(
    ...
    steps: [
      ...
      'Heat the butter and oil in a large pan (allow the fat to get very hot) and fry the schitzels until golden brown on both sides.',
  ...
  Meal(
    ...
    steps: [
      ...
      'Pour or scoop the butter onto the griddle, using approximately 1/4 cup for each pancake. Brown on both sides and serve hot.'
    ],
    isGlutenFree: true,
    isVegan: false,
    isVegetarian: true,
  ...
  Meal(
    ...
    steps: [
      ...
      'Melt 1 tablespoon butter in a skillet over medium heat. Sprinkle in flour. Whisk until four is incorporated into butter and mixture thickens.',
      ...
      'Add the rest of the egg whitesl gently fold into the chocolate with a spatula, lifting from the bottom and folding over.',
      'Stop mixing after the egg white disappears. Divide mixture between 2 prepared ramekins. Place ramekins on prepared baking sheet.',
      'Bake in preheated oven until scuffles are puffed and have ries above the top of the rims, 12 to 15 minutes.'
    ],
    isGlutenFree: true,
    isVegan: false,
    isVegetarian: true,
